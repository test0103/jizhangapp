<template>
    <div class="register">
        ...
        <div class="input">
            <div class="one"><img src="../../../static/images/phone@2x.png" alt="">|<input type="text" v-model="phone" maxlength="11" onkeyup="value=value.replace(/[^\d]/g,'')" placeholder="请输入手机号"></div>
        ...
        <div class="zhuce" @click="register">
            注册
        </div>
    </div>
</template>
        ...
        register() {
            ...
            remote
                ...
                .then(res => {
                    // console.log(res);
                    if (res.data.code=='-10') {
                        MessageBox('温馨提示',res.data.result)
                    }
                    if (res.data.code=='200') {
                        ...
                        remote.addBill({
                            bookType:'日常账本',
                            photo:'https://ws3.sinaimg.cn/large/a3db64b2gy1fw929slx0rj205a06owg5.jpg',
                            userId:this.userId,
                            note:'记录生活点滴，和家人一起分享'
                        }).then(res1 => {
